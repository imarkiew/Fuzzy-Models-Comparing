...
run_tests(name_of_file, target_column_name_or_number, is_header_present, delimiter, num_of_labels, percent_of_train_examples, number_of_iterations, name_of_saved_file)